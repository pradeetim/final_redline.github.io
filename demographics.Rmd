...
### Average Redlining Score in Each Borough（-delete):
...
health_data |>
  ...
  mutate(
    ...
    highchol_rate = mean(highchol, na.rm = FALSE)
  ) |>
  select(red_grade, obesity_rate, diabetes_rate, highchol_rate) |>
  pivot_longer(cols = c(obesity_rate, diabetes_rate, highchol_rate), 
  ...
  scale_fill_manual(values = c("diabetes_rate" = "#1f77b4",
                              "obesity_rate" = "#ff7f0e",  
                              "highchol_rate" = "#2ca02c")) +
  theme(axis.text.x = element_text(angle = 45, hjust = 1), legend.position = "none")

```

The graph compares the impact of redlining on health outcomes (diabetes, obesity, and high cholesterol) in different areas.
The higher redlining scores (A, B) tend to have slightly higher obesity and high cholesterol rates, potentially indicating the complex intersection of socioeconomic status, healthcare access, and environmental factors related to historical redlining.
