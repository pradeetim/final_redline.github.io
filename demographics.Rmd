...
This graph shows the average redlining scores in each borough. Although it looks fairly different, the range is fairly low, between ~3.06 and ~3.24. This does not give us too much information. Lets look at the median score and its distribution: 

### Redlining Score Distributions in Each Borough:
