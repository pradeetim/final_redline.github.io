...
One strength of this study is the integration of multiple data sources, allowing for a comprehensive analysis of the socioeconomic and health dimensions of food insecurity. By combining visualizations and statistical models, this research provides insights into the legacy of redlining and its implications for modern-day disparities. However, limitations remain. The right-skewed distribution of SNAP enrollment posed challenges to modeling assumptions, which we addressed through log transformations. Additionally, the cross-sectional design limits causal interpretations, and aggregated census tract-level data may obscure individual variations.

Our findings underscore the persistent impact of discriminatory housing policies on food insecurity and health outcomes in historically marginalized neighborhoods. Redlined areas remain disadvantaged in terms of food access, particularly regarding affordable and nutritious options, which has contributed to higher obesity rates. Furthermore, the intersection of race, disability, and economic vulnerability continues to play a critical role in perpetuating these disparities.
