...
To assess the predictive performance of the three multivarite models, Monte Carlo cross-validation was conducted, calculating the Root Mean Square Error (RMSE) for each model across multiple training and testing splits.
